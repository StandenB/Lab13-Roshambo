...
public class Validator {
	...
	public static Date getDate(Scanner scnr, String prompt) {  //throws ParseException could add
		boolean isValid = false;
		...
		String input;
		do {
			// get the raw string from terminal
			input = getString(scnr, prompt);
			// conver it to a date
			try {
				// throws PraseException with much be checked before compiling
